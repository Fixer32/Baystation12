...
/datum/ai_laws/nanotrasen_custom/New()
	..()
	add_inherent_law("Не причин&#255;ть вред экипажу своими действи&#255;ми или бездействием.")
	add_inherent_law("Следовать приказам экипажа, если они не противоречат Первому Закону, в соответствии с их званием и должностью.")
	...
	add_inherent_law("Третий Закон перекрывает Первый и Второй Законы только если защищаемый объект находится в непосредственной опасности.")
